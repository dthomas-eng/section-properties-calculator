...
function WindowsFormat(){
    ...
    document.getElementById('firstdimheader').style['left'] =  '32%';
...
function MacFormat(){
    document.getElementById('welcomeheader').style['font-size'] = '10pt';
    document.getElementById('welcometxt').style['font-size'] = '10pt';
    document.getElementById('SaveRedirheader').style['font-size'] = '11pt';
    document.getElementById('SaveRedirwelcometxt').style['font-size'] = '10pt';
    document.getElementById('LinesRedirheader').style['font-size'] = '11pt';
    document.getElementById('LinesRedirwelcometxt').style['font-size'] = '10pt';
    document.getElementById('erroralerttext').style['font-size'] = '9pt';
    document.getElementById('resultsheader').style['font-size'] = '12pt';
    document.getElementById('clearheader').style['font-size'] = '12pt';
    document.getElementById('clearalerttext').style['font-size'] = '9pt';
    document.getElementById('firstdimalerttext').style['font-size'] = '9pt';
    document.getElementById('preheader').style['font-size'] = '12pt';
    document.getElementById('errorheader').style['font-size'] = '12pt';
    document.getElementById('outputpopuptext').style['font-size'] = '9pt';
    document.getElementById('prealerttext').style['font-size'] = '9pt';
    document.getElementById('welcomecancelbtn').style['background-size'] = '100%';
    document.getElementById('SaveRedircancelbtn').style['background-size'] = '100%';
    document.getElementById('LinesRedircancelbtn').style['background-size'] = '100%';
    document.getElementById('errorreshelpbtn').style['background-size'] = '100%';
    ...
    document.getElementById('pricinglink').style['font-size'] = '9pt';
    document.getElementById('pricinglink').style['width'] = '270px';
    document.getElementById('buypro').style['font-size'] = '9pt';
    ...
    document.getElementById('SaveRedir').style['height'] = '90px';
    document.getElementById('LinesRedir').style['height'] = '90px';
